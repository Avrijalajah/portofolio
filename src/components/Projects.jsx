        ...
        <section id="projects" className="py-20 bg-gray-100 dark:bg-gray-800 transition-colors duration-500">
            <div className="max-w-5xl mx-auto px-6">
                ...
                <div className="flex justify-center mb-8 space-x-4">
                    <button onClick={() => filterProjects('all')} className="filter-btn bg-primary text-white px-4 py-2 rounded">Semua</button>
                    <button onClick={() => filterProjects('web')} className="filter-btn bg-gray-300 dark:bg-gray-700 px-4 py-2 rounded">Web</button>
                    <button onClick={() => filterProjects('ui')} className="filter-btn bg-gray-300 dark:bg-gray-700 px-4 py-2 rounded">UI</button>
                </div>
                ...
                <div id="projectGrid" className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div className="project-card" data-category="web">
                        <div className="bg-white dark:bg-gray-700 p-4 rounded shadow hover:shadow-lg transition-colors duration-500">
